...
from uigen.theme import Theme, get_theme


class LNativeRenderer(BaseRenderer):
    """Generates standalone HTML files with Tailwind CSS and vanilla JS."""

    def __init__(self, theme: str | Theme | None = None):
        """Initialize renderer with optional theme.

        Args:
            theme: Theme name (str) or Theme object. Defaults to "default".
        """
